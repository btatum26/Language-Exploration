...
- `spectrogram_playground/model`: authoritative application state; `spectrogram_playground/audio`: decoding, mixing, playback, recording; `spectrogram_playground/analysis`: cached numerical work; `spectrogram_playground/ui`: main-thread Qt widgets; `tests`: unit and headless Qt coverage.
